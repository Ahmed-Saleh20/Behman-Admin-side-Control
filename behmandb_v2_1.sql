...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2020 at 05:31 PM
...
(66, 'I suffer a lot with my child, because he is naughty, a lot of movement, and he always abounds and destroys things. He does not play with children. He always keeps alone in his room, he listens to the mobile phone on things that have no value, I find that he has a goal that he likes to reach.', '2020-07-23 16:18:28', 1, 0, 2, NULL, 0, 0, 0, 1, 39),
...
(75, 'Welcome, I am a psychiatrist', '2020-07-23 16:18:28', 1, 0, 1, NULL, 0, 0, 0, 0, 38),
(78, 'I have a problem with my son in learning because he is slow to understand and needs a great effort in learning.', '2020-07-23 18:21:25', 1, 0, 1, NULL, 0, 0, 0, 5, 35),
(79, 'Good evening. I am married. I have four children, married with 12 years of age, always in trouble with my wife. What do you advise me to do and when I feel that we will complete it together?', '2020-07-28 00:38:32', 1, 0, 1, NULL, 0, 0, 0, 4, 32);
...
(38, 'Mark ', 'Enim', '0112048520', '6 Octobar', 'Mark  Enim', 'Hello!! This is my default status', '123', 'Mark@gmail.com', 'United States of America', 'Male', '2020-07-21', 'images.PNG.93', 'unnamed.jpg.76', '2020-07-23 15:20:47', 'yes', 'ifyouaregootatsomethingdontdoitforfree45566677888', 2, '103_Ahmed CV.pdf', 1, 0, 0, 0, 0, NULL, NULL),
...
--
ALTER TABLE `file`
  MODIFY `file_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=172;

--
-- AUTO_INCREMENT for table `folder`
--
ALTER TABLE `folder`
  MODIFY `folder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `playlist`
  MODIFY `list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
